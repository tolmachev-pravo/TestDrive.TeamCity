...
namespace TestDrive.TeamCity.Library
{
    /// <summary>
    ...
    public static class DocumentationExtensions
	{
		...
		{
			return memberInfo.GetMemberElement("summary");
		}

		/// <summary>
		/// Returns the Xml documentation element for this member
		/// </summary>
		/// <param name="memberInfo"></param>
		/// <param name="name">Name of element</param>
		/// <returns></returns>
		public static string GetMemberElement(this MemberInfo memberInfo, string name)
		{
			var element = memberInfo.GetDocumentation();
			var summaryElm = element?.SelectSingleNode(name);
		...
		/// </summary>
		private static readonly ConcurrentDictionary<Assembly, XmlDocument> Cache = new ConcurrentDictionary<Assembly, XmlDocument>();
